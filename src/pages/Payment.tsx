        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2">
            ...
            <div className="bg-white rounded-lg p-6 mb-6 shadow-sm">
              ...
              {/* Card Payment Option */}
              <div className="border rounded-lg p-4 mb-3 cursor-pointer" onClick={() => handlePaymentMethodChange('card')}>
              ...
              <div className="border rounded-lg p-4 cursor-pointer" onClick={() => handlePaymentMethodChange('split')}>
                <div className="flex items-center justify-between">
                  <div>
            ...
            <div className="bg-white rounded-lg p-6 mb-6 shadow-sm">
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm">
                <li>Этот тариф не подлежит возврату. Если вы измените или отмените бронирование, вы не получите возврат или кредит на оплату будущего проживания.</li>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <div className="flex items-start mb-4">
                ...
                <div>
                  ...
                  <a href="#" className="text-sm text-blue-600">Условия и положения</a>
                  <span className="text-sm"> и </span>
                  <a href="#" className="text-sm text-blue-600">Политика конфиденциальности ЖерТану</a>.
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <img src="https://via.placeholder.com/50" alt="Tour" className="w-12 h-12 rounded-lg object-cover mr-3" />
