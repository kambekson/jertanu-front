      ...
      <div className="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        <ul>
          <li>
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`mr-3 ${isActive('/agency/hot-tours') ? 'text-blue-600' : 'text-gray-600'}`}>
                <path d="M12 2v8.5L7.5 14.5"/>
                <circle cx="12" cy="14" r="8"/>
              </svg>
              <span className={isActive('/agency/hot-tours') ? 'text-blue-600' : ''}>Горящие туры</span>
          ...
          <li>
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`mr-3 ${isActive('/agency/my-tours') ? 'text-blue-600' : 'text-gray-600'}`}>
          ...
          <li>
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`mr-3 ${isActive('/agency/requests') ? 'text-blue-600' : 'text-gray-600'}`}>
                <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
                <polyline points="22 4 12 14.01 9 11.01"/>
              </svg>
              <span className={isActive('/agency/requests') ? 'text-blue-600' : ''}>Просмотр заявок</span>
          ...
          <li>
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`mr-3 ${isActive('/agency/ads') ? 'text-blue-600' : 'text-gray-600'}`}>
          ...
          <li>
            ...
            >
              <Mail size={16} className={`mr-3 ${isActive('/agency/promos') ? 'text-blue-600' : 'text-gray-600'}`} />
      ...
      <div className="bg-white rounded-lg shadow-sm overflow-hidden mt-4">
        ...
        <ul>
          <li>
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`mr-3 ${isActive('/agency/about') ? 'text-blue-600' : 'text-gray-600'}`}>
          ...
          <li>
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`mr-3 ${isActive('/agency/settings') ? 'text-blue-600' : 'text-gray-600'}`}>
